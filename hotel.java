    ...
    private static void addCustomer() {
        ...
        do {
            ...
            switch (selection) {
                case "y":
                addCustomer();
                 break; // Add this break statement to exit the loop if the user chooses to continue
                ...
                System.out.println("");
                menu();
                break; // Add this break statement to exit the loop if the user chooses not to continue
